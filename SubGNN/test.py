...
def main(args_script):
    args_to_function = {
        ...
        "compute_efficiency": args_script.compute_efficiency,
    ...
    exp_results_file = open(os.path.join(config.PROJECT_ROOT, args.tb_dir, args.tb_name, "experiment_results.json"),
                            "w")
